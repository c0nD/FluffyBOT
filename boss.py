...
class Boss:
    ...
    def __attrs_post_init__(self):
        ...
        self.hp_list = [0, 8400000, 13692000, 21246400, 31393600, 44172800, 59192000, 75549600, 91834400,
                        ...
                        888395200, 915247200, 942911200, 971415200, 1000776000, 1031027200, 1062191200,
                        1094296000, 1127369600, 1161445600, 1196552000, 1232716800, 1269973600, 1308361600,
                        1347908800, 1388648800, 1430620800, 1473864000, 1518412000, 1564304000, 1611584800,
                        1660288000, 1762168800, 1815430400, 1870304800, 1926831200, 1985071200, 2045069600,
                        2106882400, 2170565600, 2236169600, 2303756000, 2373386400, 2445122400, 9999999999999,
