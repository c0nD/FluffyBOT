...
class Boss:
    ...
    def __attrs_post_init__(self):
        ...
        self.hp_list = [0, 8400000, 13692000, 21246400, 31393600, 44172800, 59192000, 75549600, 91834400,
                        ...
                        1660299200, 1710480800, 1762180000, 1815441600, 1870304800, 1926831200, 1985071200,
                        2045069600, 2106882400, 2170565600, 2236169600, 2303756000, 2373386400, 2445122400,
